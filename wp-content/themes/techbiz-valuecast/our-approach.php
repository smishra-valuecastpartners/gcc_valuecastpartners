...
<div class="element-our-approach">
      <section class="hero" id="hero" style="background-image: url('<?php echo esc_url(home_url('/wp-content/uploads/2026/04/our-approach-scaled.png')); ?>'); background-size: cover; background-position: center; background-repeat: no-repeat;">
        <div class="frame">
          <div class="div">
            <!-- <div class="frame-2">
              <div class="rectangle"></div>
              <div class="we-are-valuecast" style="color: #ffffff;">WE ARE VALUECAST</div>
            </div> -->
      ...
      <div class="middle">
        <div class="insight-cards" id="insight-cards">
          <div class="component card-panel" id="card-0" data-card="0">
            <div class="frame-3">
              <div class="frame-4">
                <div class="group">
                  <div class="group-2">
              ...
              <div class="frame-15">
                <div class="text-wrapper-4">Diagnose the Growth Engine</div>
                <p class="p">We analyze the entire customer and revenue journey — marketing, digital, creative, sales, product, and operations — to identify friction and unlock efficiency.</p>
              </div>
            </div>
          ...
          <div class="component-2 card-panel" id="card-1" data-card="1">
            <div class="frame-3">
              ...
              <div class="frame-15">
                ...
                <p class="text-wrapper-8">All working together as a shared center of excellence.</p>
              </div>
            </div>
            <div class="overlay"></div>
          </div>
          <div class="component-3 card-panel" id="card-2" data-card="2">
            <div class="frame-3">
              ...
              <div class="frame-15">
                <p class="text-wrapper-4">Build With an Operator's Mindset</p>
                <p class="text-wrapper-6">Unlike traditional investors, our team brings hands-on operational experience in scaling global marketing functions, GCCs, and performance media portfolios.</p>
              </div>
            </div>
            <div class="overlay"></div>
          </div>
          <div class="component-4 card-panel" id="card-3" data-card="3">
            <div class="frame-27">
              <div class="frame-25">
              ...
              <div class="frame-15">
                <p class="text-wrapper-4">Drive AI-Powered Efficiency &amp; Scale</p>
                <p class="text-wrapper-6">Our proprietary tools create a continuous cycle of measurement, attribution, optimization, and automation.</p>
              </div>
            </div>
            <div class="overlay"></div>
          </div>
          <div class="component-5 card-panel" id="card-4" data-card="4">
            <div class="frame-3">
              <div class="frame-4">
                <div class="group-9">
              ...
              <div class="frame-15">
                <div class="text-wrapper-4">Compound Long-Term Value</div>
                <div class="frame-35">
                  <p class="text-wrapper-13">As each company strengthens, the whole ecosystem gets stronger — creating competitive advantages that compound over time.</p>
                </div>
              </div>
            </div>
            <div class="overlay"></div>
        ...
        <!-- <div class="card-dots" id="card-dots" aria-label="Card navigation">
          <button class="card-dot card-dot--active" data-target="0" aria-label="Card 1" aria-current="true"></button>
          <button class="card-dot" data-target="1" aria-label="Card 2"></button>
          <button class="card-dot" data-target="2" aria-label="Card 3"></button>
          <button class="card-dot" data-target="3" aria-label="Card 4"></button>
          <button class="card-dot" data-target="4" aria-label="Card 5"></button>
        </div> -->
      </div>
    ...
    <script>
      ...
      function showCard(index) {
        cards.forEach((card, i) => {
          if (i === index) {
            ...
            card.querySelector('.overlay').style.opacity = '0.55';
          }
        });
        dots.forEach((dot, i) => {
          dot.classList.toggle('card-dot--active', i === index);
          dot.setAttribute('aria-current', i === index ? 'true' : 'false');
        });
      }
      dots.forEach(dot => {
        dot.addEventListener('click', () => {
          showCard(parseInt(dot.dataset.target));
        });
      });
      function initCards() {
      ...
      function handleCTAClick() {
        ...
        btnText.textContent = 'BOOKING IN PROGRESS...';
        btn.disabled = true;
        btn.style.opacity = '0.75';
        setTimeout(() => {
          btnText.textContent = '✓ WE\'LL BE IN TOUCH SOON!';
          btn.style.opacity = '1';
        }, 1800);
      }
    </script>
